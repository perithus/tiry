...
const copy = {
  en: {
    ...
    subheading: "Track delivery, booking, and communication for one campaign record.",
    ...
    notePlaceholder: "Add planning context, delivery feedback, or a campaign update.",
    addNote: "Add note",
    noNotes: "No notes yet.",
    messages: "Campaign conversation",
    noMessages: "No messages in this conversation yet.",
    messagePlaceholder: "Write a message to the fleet team...",
    send: "Send message",
    files: "Campaign files",
    filesHelp: "Upload briefs, signed PDFs, mockups, and delivery proof for this campaign workspace.",
    fileLabel: "File label",
    fileLabelPlaceholder: "Optional label, e.g. signed brief",
    ...
    phase: "Phase",
    wrapUp: "Post-campaign feedback",
    feedback: "Share campaign delivery feedback and renewal notes.",
    rating: "Rating 1-5",
  ...
  pl: {
    ...
    subheading: "Sledz realizacje, booking i komunikacje dla pojedynczej kampanii.",
    ...
    notes: "Notatki kampanii",
    notePlaceholder: "Dodaj kontekst planowania, feedback z realizacji albo aktualizacje kampanii.",
    addNote: "Dodaj notatke",
    noNotes: "Brak notatek.",
    messages: "Rozmowa kampanii",
    noMessages: "W tej rozmowie nie ma jeszcze wiadomosci.",
    messagePlaceholder: "Napisz wiadomosc do zespolu floty...",
    send: "Wyslij wiadomosc",
    files: "Pliki kampanii",
    filesHelp: "Wrzucaj briefy, podpisane PDF-y, mockupy i proofy realizacji w jednym workspace kampanii.",
    fileLabel: "Etykieta pliku",
    fileLabelPlaceholder: "Opcjonalna etykieta, np. podpisany brief",
    ...
    phase: "Etap",
    wrapUp: "Feedback po kampanii",
    feedback: "Podziel sie feedbackiem o realizacji i szansie na kolejna kampanie.",
    rating: "Ocena 1-5",
...
export default async function AdvertiserCampaignDetailPage({ params }: { params: Promise<{ campaignId: string }> }) {
  noStore();
  ...
  return (
    <DashboardShell
      ...
      heading={`${c.heading}: ${campaign.name}`}
      subheading={c.subheading}
      locale={locale}
    >
      <div className="flex justify-start">
        <Link href="/advertiser/campaigns" className="rounded-2xl border border-ink-200 bg-white px-4 py-2.5 text-sm font-medium text-ink-900 hover:bg-ink-50">
          {c.back}
        </Link>
      </div>
        ...
        <div className="space-y-6">
          <section className="glass-panel p-6">
            ...
            <div className="mt-5 grid gap-3 text-sm text-ink-600 md:grid-cols-2">
              ...
              <p><span className="font-medium text-ink-900">{c.carrier}:</span> {campaign.company?.displayName ?? "N/A"}</p>
