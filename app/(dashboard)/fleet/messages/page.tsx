...
const copy = {
  en: {
    counterpart: "Advertiser",
    listing: "Listing",
    status: "Status",
    empty: "No conversation threads yet. Reply here once advertiser communication starts.",
    noMessages: "No messages in this thread yet.",
    placeholder: "Write a message to the advertiser...",
    send: "Send message"
  },
  pl: {
    counterpart: "Reklamodawca",
    listing: "Oferta",
    status: "Status",
    empty: "Nie ma jeszcze wątków rozmów. Tutaj odpowiesz, gdy ruszy komunikacja z reklamodawcą.",
    noMessages: "W tym wątku nie ma jeszcze wiadomości.",
    placeholder: "Napisz wiadomość do reklamodawcy...",
          ...
          inquiries.map((inquiry) => (
            <div key={inquiry.id} className="glass-panel p-6">
              ...
              <div className="mt-4 grid gap-2 text-sm text-ink-600 md:grid-cols-3">
                <p>
                  <span className="font-medium text-ink-900">{c.counterpart}:</span> {inquiry.advertiser.name}
                </p>
                <p>
