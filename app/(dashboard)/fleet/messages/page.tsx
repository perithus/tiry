...
const copy = {
  en: {
    ...
    inquiryPlaceholder: "Write a message to the advertiser...",
    campaignPlaceholder: "Write a campaign update...",
    send: "Send message",
  ...
  pl: {
    ...
    inquiryPlaceholder: "Napisz wiadomosc do reklamodawcy...",
    campaignPlaceholder: "Napisz aktualizacje kampanii...",
...
export default async function FleetMessagesPage({
  ...
  const inquiryThreads = inquiries.map((inquiry) => {
    ...
    return {
      ...
      counterpart: inquiry.advertiser.name,
  ...
  const campaignThreads = campaigns.map((campaign) => {
    ...
    return {
      ...
      title: campaign.name,
      counterpart: campaign.advertiser.name,
